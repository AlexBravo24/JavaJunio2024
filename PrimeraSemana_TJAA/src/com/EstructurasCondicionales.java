...
public class EstructurasCondicionales {
	...
	public static void main(String[] args) {
		...
		//AND, OR, NOT, IGUALDAD, DIFERNTE DE
		...
		//Cuando empleamos un solo simbolo de igual (=), estamos frente a una sola asignacion
		//de valor 
		...
		*/
		...
		//Este tipo de estructura es útil cuando tenemos que evaluar varias
		//condiciones y con varios operadores 
		...
		//Esta estructura es útil cuando existen varias opciones frente al cambio 
		//de una variable 
		...
		case 'a':
			System.out.println("Lunes");
			break; // aqui se rompe la evaluacion de los demás casos.
		case 'b':
			System.out.println("Martes");
			break;
		case 'c':
