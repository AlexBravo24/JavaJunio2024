...
public class Principal {
	...
	//Vamos a crear nuestra base de datos
		...
		//1. Creando la cuenta y agregandola después 
		
		Cuenta jaz = new Cuenta("Jaz", 15000, 2000, 50000, "Débito");
		
		cuentas.put(1001, jaz);
		
		//2. Creando las cuentas directamente en el HashMap 
		cuentas.put(1002, new Cuenta("Rosa", 500, 100, 12000, "Débito"));
		cuentas.put(1003, new Cuenta("Valeria", 1500, 1000, 25000, "Débito"));
		cuentas.put(1004, new Cuenta("Zaid", 3000, 500, 30000, "Débito"));
