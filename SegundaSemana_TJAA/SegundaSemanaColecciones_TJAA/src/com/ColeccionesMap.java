...
public class ColeccionesMap {
	...
	public static void main(String[] args) {
		...
		//	La interfaz Map asocia o almacena los datos en 
		//pares (Clave - valor a almacenar)
		//Las claves no pueden duplicarse 
		
		//Es decir, la clave actua como un identificador unico 
		//para cada elemento a almacenar (ID)
		
		//Ejemplo de una declaración de un Map y la clase HashMap
		...
		//Como imprimir en pantalla un solo valor almacenado en
		...
		//Imprimir en consola las llaves de mis HashMap
		System.out.println(usuarios.keySet());
		
		//Imprimir en consola los valores contenidos en mi HashMap
		System.out.println(usuarios.values());
		
		//Mandar a imprimir cada una de las llaves con un 
		//ciclo for each
