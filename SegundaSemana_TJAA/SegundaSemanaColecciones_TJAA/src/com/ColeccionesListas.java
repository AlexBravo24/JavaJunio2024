...
public class ColeccionesListas {
	...
	public static void main(String[] args) {
		...
		//Listas - Son una colección de datos o elementos definida
		...
		//Devuelve la ultima posicion donde se encuentra al elemento 
		...
		//el elemento del indice indicado 
		System.out.println(lista);
		...
		//Puedo almacenar varios elementos si parametrizo mi lista con elementos
		//Object o si no la parametrizo 
