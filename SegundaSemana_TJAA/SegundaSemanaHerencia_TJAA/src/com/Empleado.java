...
public class Empleado extends Persona{
	...
	//Esto nos va a permitir reciclar código y solo declarar aqui
	...
	public void sumar(int a, int b) {
		...
		// Las clases hijas que heredan de una clase abstracta, deben definir cómo
		//se realizará esta acción 
	...
	@Override
	public void sumar() {
		//Ahora la lógica que antes utilizabamos en la programación estructurada
		//la puedo guardar pero aqui en métodos para solicitar los números a sumar
		//pero por teclado
		int a;
		int b;
