...
public class MetodosString {
	...
	public static void main(String[] args) {
		...
		//.length() - devolver en valor entero el tamaño de nuestra cadena
		//de texto
		...
		//posicion
		//La ultima posicion sería un valor antes de la longitud
		...
		//.equalsIgnoreCase() - compara el valor de cadenas de texto
