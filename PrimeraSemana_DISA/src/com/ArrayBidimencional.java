...
public class ArrayBidimencional {
	...
	public static void main(String[] args) {
		// ARRAY BIDIMENSIONAL
		//Nos permite añlmacenar datos de forma tabular pasando a un concepto de "tabla"
		...
		//SIN EMBARGO...
		//Existe una clase en Java que nos permite almacenar mas de un tipo de dato y sería la clase "Object"
