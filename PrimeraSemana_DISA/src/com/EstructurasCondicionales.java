...
public class EstructurasCondicionales {
	...
	public static void main(String[] args) {
		// Estructuras de desición If - evaluan valores booleanos
		...
		//Ejemplo, tenemos una variables con un determinado valor
		/*
		int x = 20;
		...
		//Cuando empleamos un solo simbolo de igual (=), estamos frente a una asignación de valor
		...
		//DIFERENTE DE - != - Compara los valores y devuelve true cuando estros valores son diferentes
		...
		//NOT - ! - Nos permite negar una condición y así ´pder cambiar su valor de true a false y viceversa
		//Por ejemplo: !NO = Sí  y !Sí = NO
		...
		*/
		...
		//Este tipo de estructura es util cuando tenemos que evaluar varias condiciones con varios operadores
		...
		case 'a':
			System.out.println("Lunes");
			break; //aqui se rompe la evaluación de los demás casos.
		case 'b':
			System.out.println("Martes");
			break;
		case 'c':
