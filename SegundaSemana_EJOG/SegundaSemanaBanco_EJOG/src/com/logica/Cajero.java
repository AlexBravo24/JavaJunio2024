...
public class Cajero implements IMetodos{
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		// Devolver un objeto >Ticket
		
		Ticket ticket = null;
		
		//Vamos a buscar la cuenta y debemos hacer unos validaciones
		...
		if(consultar(numeroCuenta) != null) {
			...
			//Una vez localizamos la cuenta, realizamos ciertaas validaciones
			if(monto>9000) {//Validamos si el monto excede el maximo del cajero
				...
				//Entonces como la operación es exitosa emitimos un nuevo ticket.
