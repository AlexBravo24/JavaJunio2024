...
public class Cajero implements IMetodos{
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		//Entonces asignamos posteriormete la cuenta si existe en el HashMap:
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		//Primero, si se encuentra o localaiza la cuenta, la asignamos para manipularla
		...
		if(consultar (numeroCuenta) !=null) {
			...
			if (monto>9000) { //Aqui validamos si el monto excede el maximo del cajero
				...
				cuenta.setSaldo(cuenta.getSaldo()-monto); //Se realiza el retiro
				//Entonces emitimos un nuevo ticket (el anterior era null)
